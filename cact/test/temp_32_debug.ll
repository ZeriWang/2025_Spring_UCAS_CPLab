...
访问数字: 0
开始LLVM IR优化...
警告: 模块验证失败，跳过优化: Integer arithmetic operators only work with integral types!
  %5 = sub float 0.000000e+00, %4
Function return type does not match operand type of return inst!
  ret i0 0
 floatInteger arithmetic operators only work with integral types!
  %2 = sub float %0, %1
...
@FACT = constant float sub (float 0.000000e+00, float 3.300000e+04), align 4
