...
define void @print_int(i32 noundef %0) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @print_float(float noundef %0) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @print_char(i8 noundef signext %0) #0 {
  %2 = alloca i8, align 1
